...
$string['cannotenrolnosessions'] = 'Cannot enrol (no face-to-face sessions in this course)';
...
$string['cohortonly_help'] = '**Face-to-Face Direct** enrolment may be restricted to members of a specified cohort only.

Note that changing this setting has no effect on existing enrolments.';
