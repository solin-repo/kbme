...
$string['pluginname_help'] = 'Matching questions require the respondent to correctly match a list of names, statements, or questions to another list of names, statements, or answers.';
