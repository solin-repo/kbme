...
$string['aim'] = 'This administration tool helps developers and test writers to create .feature files describing Totara\'s functionalities and run them automatically. Step definitions available for use in .feature files are listed below.';
...
$string['fieldvalueargument_help'] = 'This argument should be completed by a field value, there are many field types, simple ones like checkboxes, selects, or textareas and complex ones like date selectors. You can check <a href="http://docs.moodle.org/dev/Acceptance_testing#Providing_values_to_steps" target="_blank">Field values</a> to see the expected field value depending on the field type you provide.';
...
<li>You ran "{$a->behatinit}" from your Totara root directory.</li>
