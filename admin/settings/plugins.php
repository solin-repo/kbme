...
if ($ADMIN->fulltree) {
    ...
    $temp->add(new admin_setting_configselect('guestloginbutton', new lang_string('guestloginbutton', 'auth'),
                                              new lang_string('showguestlogin', 'auth'), '0', array('0'=>new lang_string('hide'), '1'=>new lang_string('show')))); // Totara: disable guests by default.
    ...
    $temp->add(new admin_setting_configtext('alternateloginurl', new lang_string('alternateloginurl', 'auth'),
                                            new lang_string('alternatelogindeprecated', 'auth', htmlspecialchars(get_login_url())), ''));
