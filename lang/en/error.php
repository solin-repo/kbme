...
$string['cannotfindteacher'] = 'Cannot find trainer';
...
$string['cannotrestoreadminoredit'] = 'You need to be a editing trainer or admin user to restore into selected course!';
...
$string['cannotuseadminadminorteacher'] = 'You need to be a trainer or admin user to use this page';
$string['cannotusepage'] = 'Only trainers and administrators can use this page';
...
$string['deletebasecategory'] = 'Can not delete the \'miscellaneous\' category.';
...
$string['mustbeteacher'] = 'You must be a trainer to look at this page';
