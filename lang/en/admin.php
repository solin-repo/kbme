...
$string['allowguestmymoodle'] = 'Allow guest access to My learning';
...
$string['cfgwwwrootslashwarning'] = 'You have defined $CFG->wwwroot incorrectly in your config.php file. You have included a \'/\' character at the end. You must remove it.';
$string['cfgwwwrootwarning'] = 'You have defined $CFG->wwwroot incorrectly in your config.php file. It does not match the URL you are using to access this page.';
...
$string['configenablemobilewebservice'] = 'Enable mobile service for the official Mobile app or other app requesting it. For more information, read the {$a}';
...
$string['configfullnamedisplay'] = 'This defines how names are shown when they are displayed in full. For most mono-lingual sites the most efficient setting value is "firstname lastname", but you may choose to hide last names altogether, or to leave it up to the current language pack to decide (some languages have different conventions). Use following placeholders to specify the format of full names: firstname, lastname, firstnamephonetic, lastnamephonetic, middlename and alternatename.';
