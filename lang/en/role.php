...
$string['archetypeeditingteacher'] = 'ARCHETYPE: Trainer (editing)';
...
$string['archetypestudent'] = 'ARCHETYPE: Learner';
$string['archetypeteacher'] = 'ARCHETYPE: Trainer (non-editing)';
...
$string['assignroles_link'] = 'Roles#Roles-Assigningsystemroles';
...
$string['backup:deletebackupfiles'] = 'Delete files from backup areas';
...
$string['backup:managebackupfiles'] = 'Manage files in backup areas';
...
$string['blog:manageentries_help'] = 'Allows the user to edit and delete blog entries created by other users';
$string['blog:manageexternal'] = 'Edit and manage external blogs';
$string['blog:manageexternal_help'] = 'Allows the user to set up a link to an external blog that supports RSS. Entries in the external blog are then automatically included within their Totara blog.';
...
$string['cohort:assign'] = 'Add and remove audience members';
$string['cohort:view'] = 'View site-wide audiences';
$string['cohort:manage'] = 'Create, delete and move audiences';
...
$string['legacy:editingteacher'] = 'LEGACY ROLE: Trainer (editing)';
$string['legacy:guest'] = 'LEGACY ROLE: Guest';
$string['legacy:student'] = 'LEGACY ROLE: Learner';
$string['legacy:teacher'] = 'LEGACY ROLE: Trainer (non-editing)';
...
$string['my:manageblocks'] = 'Manage My Learning page blocks';
$string['my:configsyspages'] = 'Configure system templates for My Learning pages';
...
$string['overridepermissions_link'] = 'Roles';
...
$string['restore:restorefile'] = 'Use backup files for restore';
...
$string['restore:restoreuntrusted'] = 'Restore backup file that is not trusted';
$string['restore:rolldates'] = 'Allowed to roll activity configuration dates on restore';
$string['restore:uploadfile'] = 'Upload backup files for restore';
