...
$string['backupdetailsnonstandardinfo'] = 'The selected file is not a standard Totara backup file. The restore process will try to convert the backup file into the standard format and then restore it.';
$string['backupformat'] = 'Format';
$string['backupformatmoodle1'] = 'Totara 1';
$string['backupformatmoodle2'] = 'Totara 2';
...
$string['choosefilefromuserbackup_help'] = 'When backup courses with **Anonymise user information** option ticked, backup files will be stored here.';
...
$string['errorminbackup20version'] = 'This backup file has been created with one development version of Totara backup ({$a->backup}). Minimum required is {$a->min}. Cannot be restored.';
$string['errorinvalidformat'] = 'Unknown backup format';
$string['errorinvalidformatinfo'] = 'The selected file is not a valid Totara backup file and can\'t be restored.';
