...
M.form.dateselector = {
    ...
    initPanel: function(config) {
        ...
        // Totara: TL-14954 Added MONTHS_LONG to save translated month names
...
CALENDAR.prototype = {
    ...
    initializer: function() {
        ...
        inputs.each(function(node) {
            ...
            } else if (node.get('name').match(/\[enabled\]/)) {
                // Totara: using just else here is silly, look for the checkbox!
    ...
    release_calendar: function(e) {
        ...
        if (this.dayselect && this.dayselect.simulate && typeof this.dayselect.simulate == 'function') {
            this.dayselect.simulate('change');
        }
    },
