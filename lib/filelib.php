...
class curl {
    ...
    public function resetopt() {
        $this->options = array();
        $this->options['CURLOPT_USERAGENT']         = 'TotaraBot/1.0';
    ...
    protected function request($url, $options = array()) {
        ...
        // Totara: CURLOPT_URL is forbidden in Totara, always use curl_init constructor.
