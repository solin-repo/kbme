...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    /**
     * Copy of ALIGNMENTS native Array constant, wrapped in an ArrayList Class
     * to allow ES5.1 feature usage.
     *
     * @property _alignmentsListShim
     * @type ArrayList
     * @private
     */
    _alignmentsListShim: null,
    ...
    initializer: function() {
        ...
        // set the ALIGNMENTS ArrayList shim, we will use this shim when iterating
        // instead of the native Array
        this._alignmentsListShim = new Y.ArrayList(ALIGNMENTS);
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (result) {
                            ...
                            newhtml = template({
                                url: file.url,
                                presentation: true,
                                // TOTARA: Responsive images for drag & drop by default.
    ...
    _applyImageProperties: function(form) {
        ...
        if (properties === false) {
            ...
            this._alignmentsListShim.some(function(alignment) {
    ...
    _getAlignmentPropeties: function(image, properties) {
        ...
        complete = this._alignmentsListShim.some(function(alignment) {
