...
class core_course_courselib_testcase extends advanced_testcase {
    ...
    public function test_course_get_user_navigation_options_for_frontpage() {
        ...
        $this->assertFalse($navoptions->competencies); // Totara: not present!
        ...
        // Totara: no need to disable competencies.
    ...
    public function test_archive_course_completion() {
        ...
        foreach ($testcourseids as $courseid) {
            // Call course/lib.php functions.
            archive_course_completion($testuser->id, $courseid);
            archive_course_activities($testuser->id, $courseid);

            // Purge any leftovers.
            archive_course_purge_gradebook($testuser->id, $courseid);
        }

        // Reset courses in progress.
        foreach ($testcourseids_inprogress as $courseid) {
            // Call course/lib.php functions.
            archive_course_completion($testuser->id, $courseid, true);
            archive_course_activities($testuser->id, $courseid);
