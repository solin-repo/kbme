...
function calendar_events_check_visibility($events) {
    ...
    debugging('calendar_events_check_visibility() has been deprecated since Totara 12.9, in favour of using totara_visibility_where() when loading events.', DEBUG_DEVELOPER);
