...
$string['tracking_help'] = 'The reminder can be sent based on the completion of the course or individual activities. Only activities which are part of course completion criteria may be selected.';
