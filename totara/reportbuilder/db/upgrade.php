...
function xmldb_totara_reportbuilder_upgrade($oldversion) {
    ...
    if ($oldversion < 2018112203) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2018112203, 'totara', 'reportbuilder');
    }
    ...
    if ($oldversion < 2018112204) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2018112204, 'totara', 'reportbuilder');
    }
    ...
    if ($oldversion < 2018112205) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2018112205, 'totara', 'reportbuilder');
    }
