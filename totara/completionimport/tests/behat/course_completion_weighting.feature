...
Feature: Make sure the grade column of CSV differs
  ...
  Scenario Outline: Course completion displayed correctly when weighted
    ...
    And I set the following fields to these values:
      | CSV Grade format | <grade_unit> |
      | Override current course completions | 0 |
    And I upload "totara/completionimport/tests/behat/fixtures/completion_upload_23158.csv" file to "Choose course file to upload" filemanager
