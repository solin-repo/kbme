...
Feature: Access rights to user goal questions in static appraisals
  User goal questions in static appraisals should be accessible
  By the manager on record for all appraisals
  And not by the current manager at all.
