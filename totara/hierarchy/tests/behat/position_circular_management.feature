...
Feature: Verify circular line management cannot be created.
  ...
  Scenario: Check it's not possible to create circular line management with an immediate subordinate.
    ...
    # You should not be able to save a position when the manager is an immediate subordinate.
    ...
    And I should see "Selecting this user as a manager will create a circular management structure. Please select another user." in the ".error" "css_element"

    When I follow "Delete"
    And I press "Update position"
    Then I should see "Position saved."
  ...
  Scenario: Check it's not possible to create circular line management in the middle of the structure.
    ...
    # Add the correct manager and update the position.
    When I navigate to "Browse list of users" node in "Site administration > Users > Accounts"
    And I follow "Frank1 Director1"
    And I follow "Primary position"
    And I press "Choose manager"
