    ...
    init: function(Y, args){
        ...
        (function() {
            ...
            totaraMultiSelectDialog(
                ...
                url+'find.php?sesskey='+M.cfg.sesskey+'&id='+M.totara_competencyitem.config.id,
                url+'save.php?sesskey='+M.cfg.sesskey+'&id='+M.totara_competencyitem.config.id+'&deleteexisting=1&add='
            );
        })();
        ...
        if (typeof M.totara_competencyitem.config.competencyuseresourcelevelevidence !== 'undefined' &&
            ...
            totaraDialog_handler_assignEvidence.prototype._handle_course_click = function(id) {
                // Load course details
                var url = this.baseurl+'course.php?sesskey='+M.cfg.sesskey+'&id='+id+'&competency='+M.totara_competencyitem.config.id;
            ...
            totaraDialog_handler_assignEvidence.prototype._display_evidence = function(response) {
                ...
                $('#available-evidence', this._dialog.dialog).find('.addbutton').click(function(e) {
                    ...
                    var url = handler.baseurl+'add.php?sesskey='+M.cfg.sesskey+'&competency='+M.totara_competencyitem.config.id+'&type='+type+'&instance='+instance;
            ...
            (function() {
                ...
                var saveurl = url + 'add.php?sesskey='+M.cfg.sesskey+'&competency='+M.totara_competencyitem.config.id+'&type=coursecompletion&instance=0&deleteexisting=1&update=';
                var buttonsObj = {};
                ...
                totaraDialogs['evidence'] = new totaraDialog(
                    ...
                    url+'edit.php?sesskey='+M.cfg.sesskey+'&id='+M.totara_competencyitem.config.id,
                    handler
                );
            })();
        }
