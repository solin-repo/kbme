...
class totara_core_certification_visibility_testcase extends advanced_testcase {
    ...
    public function test_complex_traditional_setup() {
        global $CFG, $DB;
        ...
        foreach ($users as $user) {
            if (empty($CFG->disable_visibility_maps)) {
                [$sql, $params] = $manager->sql_where_visible($user->id, 'p');
    ...
    public function test_complex_traditional_setup_with_maps_disabled() {
        global $CFG;
        $CFG->disable_visibility_maps = true;

        $this->test_complex_traditional_setup();

        unset($CFG->disable_visibility_maps);
    }

    public function test_complex_audience_based_setup() {
        global $CFG, $DB;
    ...
    public function test_complex_audience_based_setup_with_maps_disabled() {
        global $CFG;
        $CFG->disable_visibility_maps = true;

        $this->test_complex_audience_based_setup();
