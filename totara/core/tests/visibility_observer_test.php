...
class totara_core_visibility_observer_testcase extends advanced_testcase {
    ...
    public function test_react_category_deleted() {
        ...
        self::assertTrue($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certification1]));
        self::assertTrue($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certification2]));
        ...
        self::assertTrue($DB->record_exists(self::TABLE_PROGRAM, ['roleid' => $roleid, 'programid' => $program2->id]));
        self::assertFalse($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certification1]));
        self::assertTrue($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certification2]));
    }
    ...
    public function test_category_moved_permission_gained() {
        ...
        self::assertFalse($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certification1]));
        self::assertFalse($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certification2]));
    ...
    public function test_react_certification_updated() {
        ...
        // Check both are up to date.
        self::assertTrue($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certificationid]));
        $DB->delete_records(self::TABLE_CERTIFICATION, ['roleid' => $roleid]);
        self::assertFalse($DB->record_exists(self::TABLE_CERTIFICATION, ['roleid' => $roleid, 'programid' => $certificationid]));

        // This bit of API is not encapsulated.
        \totara_certification\event\certification_updated::create_from_instance(new program($certificationid))->trigger();
