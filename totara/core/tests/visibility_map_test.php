...
class totara_core_visibility_map_testcase extends advanced_testcase {
    ...
    public function test_certification_generate_map() {
        ...
        $roleid = (string)$this->getDataGenerator()->create_role();
        assign_capability($map->get_view_hidden_capability(), CAP_ALLOW, $roleid, \context_program::instance($p2));
        assign_capability($map->get_view_hidden_capability(), CAP_ALLOW, $roleid, \context_coursecat::instance($cat->id));
        ...
        $expected = [
            $p1 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid],
            $p2 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p3 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p4 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
        ];
        ...
        $map->recalculate_map_for_instance($p6);
        ...
        $expected = [
            ...
            $p3 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p4 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p6 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid],
        ];
        ...
        $expected = [
            ...
            $p2 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p4 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p5 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid, $roleid],
            $p6 => [$managerid, $certificationcreatorid, $editingtrainerid, $teacherid],
        ];
        self::assertSame($expected, $actual());
