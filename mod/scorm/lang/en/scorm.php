...
$string['displayattemptstatus_help'] = 'This preference allows a summary of the users attempts to show in the course overview block in My learning and/or the SCORM entry page.';
$string['displayattemptstatusdesc'] = 'Whether a summary of the user\'s attempts is shown in the course overview block in My learning and/or the SCORM entry page.';
...
$string['forcenewattempt_help'] = 'If **yes**, hides the **Start new attempt** checkbox and prevents review mode.
