...
$string['cannotaddteacherforumto'] = 'Could not add converted trainer forum instance to section 0 in the course';
$string['cannotcreatediscussion'] = 'Could not create new discussion';
$string['cannotcreateinstanceforteacher'] = 'Could not create new course module instance for the trainer forum';
...
$string['cannotviewpostyet'] = 'You cannot read other learners questions in this discussion yet because you haven\'t posted';
...
$string['completiondiscussions'] = 'Learner must create discussions:';
...
$string['completionposts'] = 'Learner must post discussions or replies:';
...
$string['completionreplies'] = 'Learner must post replies:';
...
$string['disallowsubscribeteacher'] = 'Subscriptions not allowed (except for trainers)';
...
$string['introteacher'] = 'A forum for trainer-only notes and discussion';
...
* A forum where each learner can post exactly one discussion.
* A question and answer forum where learners must first post before being able to view other learners\' posts.

A trainer can allow files to be attached to forum posts. Attached images are displayed in the forum post.

Participants can subscribe to a forum to receive notifications of new forum posts. A trainer can set the subscription mode to optional, forced, auto, or prevent subscription completely. If required, learners can be blocked from posting more than a given number of posts in a given time period; this can prevent individuals from dominating discussions.
...
* A help centre where tutors and learners can give advice.
...
$string['nameteacher'] = 'Trainer forum';
...
$string['searchuserid'] = 'The Totara ID of the author';
