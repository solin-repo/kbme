...
Feature: Submit assignment without group
  ...
  Scenario: Switch between group modes
    ...
    Then I should not see "You're not a member of any group, please contact your trainer."
    ...
    Then I should see "You're not a member of any group, please contact your trainer."
    And I should see "Nothing has been submitted for this assignment"
