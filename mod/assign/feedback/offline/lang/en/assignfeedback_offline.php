...
$string['enabled_help'] = 'If enabled, the trainer will be able to download and upload a worksheet with learner grades when marking the assignments.';
...
$string['gradesfile_help'] = 'Grading worksheet with modified grades. This file must be a CSV file that has been downloaded from this assignment and must contain columns for the learner grade, and identifier. The encoding for the file must be UTF-8.';
