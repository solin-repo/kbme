...
$string['enabled_help'] = 'If enabled, the trainer will be able to upload files with feedback when marking the assignments. These files may be, but are not limited to marked up learner submissions, documents with comments, or spoken audio feedback.';
$string['feedbackzip'] = 'Zip file with feedback files';
$string['feedbackfileadded'] = 'New feedback file "{$a->filename}" for learner "{$a->student}"';
$string['feedbackfileupdated'] = 'Modified feedback file "{$a->filename}" for learner "{$a->student}"';
$string['feedbackzip_help'] = 'A zip file containing a list of feedback files for one or more learners. Feedback files will be assigned to learners based on the participant id which should be the second part of each filename immediately after the users full name. This naming convention is used when downloading submissions so you can download all submissions, add comments to a few files and then rezip and upload all of the files. Files with no changes will be ignored.';
