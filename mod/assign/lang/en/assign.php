...
$string['eventoverridecreated'] = 'Assignment user override created';
$string['eventoverridecreatedgroup'] = 'Assignment group override created';
$string['eventoverridedeleted'] = 'Assignment user override deleted';
$string['eventoverridedeletedgroup'] = 'Assignment group override deleted';
$string['eventoverrideupdated'] = 'Assignment user override updated';
$string['eventoverrideupdatedgroup'] = 'Assignment group override updated';
...
$string['gradingnotrequired'] = 'Assignment does not require a grade';
...
$string['inactiveoverridehelp'] = '* Learner does not have the correct group or role to attempt the assignment';
...
$string['usersnone'] = 'No learners have access to this assignment.';
