...
$settings = new admin_settingpage($section, get_string('generalsettings', 'mod_facetoface'), 'totara/core:modconfig', $module->is_enabled() === false);
...
$ADMIN->add('modfacetofacefolder', new admin_externalpage('modfacetofacesitenotices', new lang_string('sitenoticesheading','facetoface'), "$CFG->wwwroot/mod/facetoface/sitenotices.php", 'totara/core:modconfig'));
