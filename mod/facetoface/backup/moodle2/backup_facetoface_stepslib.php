...
class backup_facetoface_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $session = new backup_nested_element('session', array('id'), array(
            ...
            'discountcost', 'roomid', 'room_name', 'room_building', 'room_address', 'room_type', 'room_custom', 'timecreated',
        ...
        $session->set_source_sql('SELECT s.id, s.facetoface, s.capacity, s.allowoverbook, s.details, s.datetimeknown,
                                         ...
                                         r.building AS room_building, r.address AS room_address, r.type AS room_type,
                                         r.custom AS room_custom, s.timecreated, s.timemodified, s.usermodified,
                                         s.selfapproval, s.mincapacity, s.cutoff, s.allowcancellations,
                                         s.cancellationcutoff, s.availablesignupnote
