...
Feature: Check the seminar events and sessions reports display correctly
  ...
  Scenario: Check the Seminar events report displays the event start and finish dates, times and timezones correctly
    ...
    Then the following should exist in the "facetoface_events" table:
      | Seminar Name      | Course Name | Event Start Date/Time | Event Start Date/Time | Event Finish Date/Time | Event Finish Date/Time |
      | Test seminar name | Course 1    | 1 January             | 3:00 AM Europe/London | 1 January              | 4:00 AM Europe/London  |
    ...
    Then the following should exist in the "facetoface_events" table:
      | Seminar Name      | Course Name | Event Start Date/Time | Event Start Date/Time    | Event Finish Date/Time | Event Finish Date/Time   |
      | Test seminar name | Course 1    | 1 January             | 4:00 PM Pacific/Auckland | 1 January              | 5:00 PM Pacific/Auckland |
    ...
    Then the following should exist in the "facetoface_events" table:
      | Seminar Name      | Course Name | Event Start Date/Time | Event Start Date/Time    | Event Finish Date/Time | Event Finish Date/Time   |
      | Test seminar name | Course 1    | 31 December           | 10:00 PM America/Toronto | 31 December            | 11:00 PM America/Toronto |
    And I should see date "31 December this year 10:00 PM America/Toronto" formatted "%d %B %Y, %I:%M %p"
    And I should see date "31 December this year 11:00 PM America/Toronto" formatted "%d %B %Y, %I:%M %p"
