...
Feature: Seminar Signup Manager Approval
  ...
  Scenario: Student can not request approval for another session with same dates
    ...
    And I follow "Classroom Connect"
    And I follow "View all events"
    And I should see "More info" in the "Requested" "table_row"
    And I should see "Cancel booking" in the "Requested" "table_row"
    And I should see "More info" in the "Booking open" "table_row"