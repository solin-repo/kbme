...
// Takes into account the suppress user notification option in the Add/remove attendees.
$suppressemail = !isset($results[3]) ? false : $results[3];
// Takes into account the suppress manager notification option in the Add/remove attendees.
$ccmanager = (isset($results[4]) && !$results[4]) ? 1 : 0;
