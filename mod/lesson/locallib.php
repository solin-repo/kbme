...
class lesson extends lesson_base {
     ...
     *
     * IMPORTANT: $sort and $fields are passed to $DB->get_records and so should be hard-coded values
     * when making the function call.
     *
     * @param  int      $userid    the user id
    ...
    public function get_user_timers($userid = null, $sort = '', $fields = '*', $limitfrom = 0, $limitnum = 0) {
        ...
        // Totara: Ensure we have valid values for the limit parameters.
...
abstract class lesson_page extends lesson_base {
    ...
    public function display_answers(html_table $table) {
        ...
        foreach ($answers as $answer) {
            $cells = array();
            $cells[] = "<span class=\"mod_lesson__label\">".get_string("jump", "lesson")." $i<span>: ";
