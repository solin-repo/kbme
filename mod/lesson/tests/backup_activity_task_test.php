...
class mod_lesson_backup_activity_task_testcase extends advanced_testcase {
    ...
    /**
     * Test encode_content_links can convert highscores links when called without a task.
     */
    public function test_encode_content_links_highscores_without_a_task() {
        global $CFG;

        // Test view.php links.
        $this->assertSame(
            '$@LESSONHIGHSCORES*3@$',
            backup_lesson_activity_task::encode_content_links($CFG->wwwroot.'/mod/lesson/highscores.php?id=3')
        );
        $this->assertSame(
            '$@LESSONHIGHSCORES*987654321@$',
            backup_lesson_activity_task::encode_content_links($CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321')
        );
        $this->assertSame(
            '<a href="$@LESSONHIGHSCORES*987654321@$">$@LESSONHIGHSCORES*987654321@$</a>',
            backup_lesson_activity_task::encode_content_links(
                '<a href="'.$CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321">'.$CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321</a>'
            )
        );
        $this->assertSame(
            '<a href="/mod/lesson/highscores.php?id=64">/mod/lesson/highscores.php?id=64</a>',
            backup_lesson_activity_task::encode_content_links(
                '<a href="/mod/lesson/highscores.php?id=64">/mod/lesson/highscores.php?id=64</a>'
            )
        );
        $this->assertSame(
            '<a href="$@LESSONHIGHSCORES*987654321@$#anchor">$@LESSONHIGHSCORES*987654321@$#anchor</a>',
            backup_lesson_activity_task::encode_content_links(
                '<a href="'.$CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321#anchor">'.$CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321#anchor</a>'
            )
        );
        $this->assertSame(
            '<a href="$@LESSONHIGHSCORES*987654321@$&arg=value">$@LESSONHIGHSCORES*987654321@$&arg=value</a>',
            backup_lesson_activity_task::encode_content_links(
                '<a href="'.$CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321&arg=value">'.$CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321&arg=value</a>'
            )
        );
    }

    /**
     * Test encode_content_links can convert highscores links when called with a valid task.
     */
    public function test_encode_content_links_highscores_with_a_task() {
        global $CFG, $USER;
        ...
        // We expect the module in course 1 to be encoded, but not the module in course 2.
        $this->assertSame(
            '$@LESSONHIGHSCORES*'.$module1->cmid.'@$',
            backup_lesson_activity_task::encode_content_links($CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module1->cmid, $roottask)
        );
        $this->assertSame(
            $CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module2->cmid,
            backup_lesson_activity_task::encode_content_links($CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module2->cmid, $roottask)
        );
        $this->assertSame(
            $CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321',
            backup_lesson_activity_task::encode_content_links($CFG->wwwroot.'/mod/lesson/highscores.php?id=987654321', $roottask)
        );

        // Test no relative URL's get encoded.
        $this->assertSame(
            '/mod/lesson/highscores.php?id='.$module1->cmid,
            backup_lesson_activity_task::encode_content_links('/mod/lesson/highscores.php?id='.$module1->cmid, $roottask)
        );
        $this->assertSame(
            '/mod/lesson/highscores.php?id='.$module2->cmid,
            backup_lesson_activity_task::encode_content_links('/mod/lesson/highscores.php?id='.$module2->cmid, $roottask)
        );
        $this->assertSame(
            '/mod/lesson/highscores.php?id=987654321',
            backup_lesson_activity_task::encode_content_links('/mod/lesson/highscores.php?id=987654321', $roottask)
        );

        // Now test the correct URL's with additional anchors and arguments.
        $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module1->cmid.'#anchor';
        $this->assertSame(
            '<a href="$@LESSONHIGHSCORES*'.$module1->cmid.'@$#anchor">$@LESSONHIGHSCORES*'.$module1->cmid.'@$#anchor</a>',
            backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        );
        $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module2->cmid.'#anchor';
        $this->assertSame(
            '<a href="'.$url.'">'.$url.'</a>',
            backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        );
        $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id=546#anchor';
        $this->assertSame(
            '<a href="'.$url.'">'.$url.'</a>',
            backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        );
        $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module1->cmid.'&arg=value';
        $this->assertSame(
            '<a href="$@LESSONHIGHSCORES*'.$module1->cmid.'@$&arg=value">$@LESSONHIGHSCORES*'.$module1->cmid.'@$&arg=value</a>',
            backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        );
        $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module2->cmid.'&arg=value';
        $this->assertSame(
            '<a href="'.$url.'">'.$url.'</a>',
            backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        );
        $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id=546&arg=value';
        $this->assertSame(
            '<a href="'.$url.'">'.$url.'</a>',
            backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        );
        ...
        // Now check that the correct activity id doesn't get converted (it should only convert the cmid).
        // $url = $CFG->wwwroot.'/mod/lesson/highscores.php?id='.$module1->id;
        // $this->assertSame(
        //      '<a href="'.$url.'">'.$url.'</a>',
        //     backup_lesson_activity_task::encode_content_links('<a href="'.$url.'">'.$url.'</a>', $roottask)
        // );
