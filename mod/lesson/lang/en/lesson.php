...
$string['defaultessayresponse'] = 'Your essay will be graded by your trainer.';
...
$string['dependencyon_help'] = 'This setting allows access to this lesson to be dependent upon a learner\'s performance in another lesson in the same course. Any combination of time spent, completed, or grade may be used.';
...
$string['displayofgrade'] = 'Display of grade (for learners only)';
...
$string['handlingofretakes_help'] = 'If retakes are allowed, this setting specifies whether the grade for the lesson is the mean or maximum of all attempts.';
...
$string['inactiveoverridehelp'] = '* Learner does not have the correct group or role to view/attempt the lesson';
...
$string['modattempts'] = 'Allow learner review';
...
$string['teacherjumpwarning'] = 'An {$a->cluster} jump or an {$a->unseen} jump is being used in this lesson.  The next page jump will be used instead.  Login as a learner to test these jumps.';
$string['teacherongoingwarning'] = 'Ongoing score is only displayed for learner.  Login as a learner to test ongoing score';
$string['teachertimerwarning'] = 'Timer only works for learners.  Test the timer by logging in as a learner.';
