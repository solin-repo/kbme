...
$string['publishafteranswer'] = 'Show results to learners after they answer';
$string['publishafterclose'] = 'Show results to learners only after the choice is closed';
$string['publishalways'] = 'Always show results to learners';
$string['publishanonymous'] = 'Publish anonymous results, do not show learner names';
$string['publishnames'] = 'Publish full results, showing names and their choices';
$string['publishnot'] = 'Do not publish results to learners';
