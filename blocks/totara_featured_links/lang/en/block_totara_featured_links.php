...
$string['icon'] = 'Icon';
$string['icon_choose'] = 'Choose';
$string['icon_choose_title'] = 'Choose icon';
$string['icon_change'] = 'Change';
$string['icon_delete'] = 'Remove';
$string['icon_help'] = 'Warning: Users with a different theme may not have the same icons as you do';
$string['icon_invalid'] = 'The Icon is invalid';
$string['icon_size'] = 'Icon size';
$string['icon_size_small'] = 'Small';
$string['icon_size_medium'] = 'Medium';
$string['icon_size_large'] = 'Large';
...
$string['managesubtiles'] = 'Edit content';
$string['managesubtiles_sr-only'] = 'Edit content for {$a} tile';
...
$string['order'] = 'Order';
$string['parenttile_content_menu_title'] = 'Configure';
$string['parenttile_content_menu_title_sr-only'] = 'Configure for {$a} tile';
$string['pauseonhover'] = 'Pause on hover';
$string['parenttile_content_menu_title'] = 'Configure';
$string['parenttile_content_menu_title_sr-only'] = 'Configure for {$a} tile';
$string['pluginname'] = 'Featured Links';
$string['position_indicator'] = 'Position indicator';
...
$string['save_edit'] = 'Save and Edit content';
...
$string['slide'] = 'Slide';
$string['stopediting'] = 'Finished editing';
$string['text'] = 'Text';
...
$string['url_title_help'] = 'URLs can be full names (http://www.sitename.com or https://www.sitename.com) or local. Local URLs should start with a slash ( / ) as this ensures the link will continue to work if the site\'s URL changes. When used, a local URL will have the site\'s web address added.';
